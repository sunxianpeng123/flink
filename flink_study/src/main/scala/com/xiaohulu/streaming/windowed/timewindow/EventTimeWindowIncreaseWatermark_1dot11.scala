...
/**
  ...
  * \* Description: 
  * \*/
object EventTimeWindowIncreaseWatermark_1dot11 {
  def main(args: Array[String]): Unit = {
    /**
      * 这个也就是相当于固定生成水印的延迟策略去掉了延迟时间，以event中的时间戳充当了水印。
      */
    //  获取运行环境
    ...
    val stream = env.fromCollection(Seq(("qh1", 100L), ("qh1", 101L)))
      .assignTimestampsAndWatermarks(WatermarkStrategy.forMonotonousTimestamps[(String,Long)]
