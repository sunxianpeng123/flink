package com.xiaohulu.demo.test.utils
...
object DateUtil {
  ...
  def timeToLong(timeStr: String): Long = {
    DateUtil.timeToLong(timeStr,DATE_FORMAT_FULL)
  }
  ...
  def timeToString(timeStamp: Long): String = {
    DateUtil.timeToString(timeStamp,DATE_FORMAT_FULL)
  }
