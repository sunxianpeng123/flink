...
class SinkToMySql extends RichSinkFunction[MessageBean]{
  ...
  def getConnection():Connection= {
    ...
    try {
      ...
      con = DriverManager.getConnection("jdbc:mysql://192.168.120.158:3306/test_sun?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true&useSSL=false", "root", "1qaz@WSX3edc")
    } catch  {
